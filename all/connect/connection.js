    ...
    if (connection === "open") {
      ...
      if (process.env.START_MSG !== 'true' && !announceCfg.announced) {
        ...
        await ednut.sendMessage(userId + "@s.whatsapp.net", {
          text: `╔═══《 🚀 _𝗟𝗨𝗠𝗜𝗡𝗔 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗_ 👾🖤》═══╗
┃
┃ ✨ _Greetings, Your Majesty_ System online — ready for action ⚡
┃
┃ 🧠 _𝗤𝘂𝗶𝗰𝗸 𝗔𝗰𝗰𝗲𝘀𝘀_
┃  • _.lumina_ : Bot info
┃  • _.list_ : All commands
┃
┃ 🖥 _𝗦𝘆𝘀𝘁𝗲𝗺 𝗗𝗮𝘁𝗮_
┃  • Prefix: ${global.prefix}
┃  • Version: ${pkg.version}${versionNote}
┃  • WhatsApp: https://w.me/patron
┃ 
┃ ⚠️ *𝗧𝗿𝗼𝘂𝗯𝗹𝗲𝘀𝗵𝗼𝗼𝘁𝗶𝗻𝗴*
┃  • Session issues? → $ {global.scan}
┃  • Update your bot SESSION_ID
┃  • Restart your host panel. 🚀
┃
┃ _NOTICE:_ Replies may take a ┃few moments — be safe, enjoy ┃your day and live a long healthy life. 👑🤍
╚═══《 👑 _𝗞𝗬𝗡𝗘𝗫𝗢𝗥-𝗧𝗘𝗖𝗛_  》═══╝�*`,
        });
